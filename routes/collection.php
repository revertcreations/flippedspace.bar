...
Route::post('/collection/{category?}', [CollectibleController::class, 'store'])->name('collection.store')->middleware('auth');

Route::post('/collection/{catalog_key}', [CollectibleController::class, 'destroy'])->name('collection.destroy')->middleware('auth');
